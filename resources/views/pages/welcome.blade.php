...
@section('header')
  <div class="wrapper col2">
          ...
          @foreach ($beritas as $berita)
              <li><a href='#'>
                <img src= "{!! URL::asset('public/storage/authentication/'.$berita->gambar_path) !!}" height='400px' width='900'>
  ...
  <div class="homepage">
  				<ul>
  					<li>
  						<h2><img src="public/img/logo/Web_lap_64.png" alt="" /></a>WebGIS</h2>
  					...
  					<li>
  						<h2><img src="public/img/logo/On_news_64.png" alt="" />Dokumen</h2>
  					...
  					<li class="last">
  						<h2><img src="public/img/logo/Loc_net_64.png" alt="" />Geoportal</h2>
